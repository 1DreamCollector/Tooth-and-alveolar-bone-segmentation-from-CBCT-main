...
parser.add_argument('--root_path', type=str, default=R'/data1/LJX/h5_roi/', help='Name of Experiment')
...
if __name__ == "__main__":
    ...
    trainloader = DataLoader(db_train, batch_size=batch_size, shuffle=True,  num_workers=4, pin_memory=True, worker_init_fn=worker_init_fn(1))

    testloader = DataLoader(db_test, batch_size=batch_size, shuffle=True,  num_workers=4, pin_memory=True, worker_init_fn=worker_init_fn(1))
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            #这就是论文中所说的，在网络训练阶段，利用二元交叉熵损失对最后一层卷积输出的概率图进行监督。得到ROI

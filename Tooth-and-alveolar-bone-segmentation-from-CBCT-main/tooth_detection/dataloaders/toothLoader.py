...
class toothLoader(Dataset):
    """ LA Dataset """
    def __init__(self, base_dir=None, split='train',cnt_or_skl=None,num=None, transform=None):
        self._base_dir = base_dir
        self.transform = transform
        self.sample_list = []
        self.cnt_or_skl = cnt_or_skl
        if split=='train':
            with open(self._base_dir + self.cnt_or_skl, 'r') as f:
    ...
    def __getitem__(self, idx):
        ...
        sample = {'image': image, 'offset_cnt': offset_cnt, 'offset_skl': offset_skl, 'label': label}
        if self.transform:
